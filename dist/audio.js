...
var _incontext = __webpack_require__(332);

var _outcontext = __webpack_require__(333);

var _config = __webpack_require__(334);

var _encoder = __webpack_require__(335);

var _ws = __webpack_require__(336);

var _blob = __webpack_require__(337);

var _as3context = __webpack_require__(338);

var _audio = __webpack_require__(339);
    ...
    _createClass(Player, [{
        ...
        value: function send() {
            if (this._incontext) {
                ...
                this._ws.send(_wavDataBuffer.buffer);
        ...
        value: function exportwav(cb) {
            if (this._incontext && typeof cb === "function") {
                ...
                var _wavblob = _blob.BlobData.wav(_wavDataBuffer2.buffer);
                this._as3context.stop();
                this._as3context.clear();
                cb(_wavblob);
            }
...
var _context = __webpack_require__(126);
...
var As3Context = exports.As3Context = function () {
    function As3Context(config) {
        ...
        if (swfobject) {
            ...
            var that = this;
            swfobject.embedSWF(swfpath, domid, ele.clientWidth, ele.clientHeight, '25.0.0', './expressInstall.swf', flashvars, params, attributes, function () {
